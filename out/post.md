...
- The SWE-agent paper introduced the Agent-Computer Interface as the key lever for agent performance on software engineering tasks.
  > "Agent-Computer Interface"
  — [source](https://arxiv.org/abs/2405.15793)

- ChatEval uses a multi-agent debate team to evaluate the quality of generated text.
  > "multi-agent referee team"
  — [source](https://arxiv.org/abs/2308.07201)

- Simon Willison's definition of an LLM agent is a model that runs tools in a loop to achieve a goal.
